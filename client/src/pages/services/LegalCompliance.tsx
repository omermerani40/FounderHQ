          ...
          <div className="max-w-3xl">
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl font-heading font-bold mb-6 leading-tight">
                Launch on Solid <br />
                <span className="text-accent">Legal Ground.</span>
              </h1>
              <p className="text-lg md:text-xl text-blue-100 mb-8 max-w-lg leading-relaxed">
                From company registration to shareholder agreements, we handle all the legal complexity so you can focus on building.
              </p>
              <Button 
                size="lg" 
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Comprehensive legal setup for Australian startups.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: Scale, title: "Company Formation", desc: "ACN/ABN registration, company structure, and ASIC compliance." },
              { icon: FileText, title: "Legal Documents", desc: "Shareholder agreements, terms of service, privacy policies." },
              { icon: Shield, title: "IP Protection", desc: "Trademark registration, IP strategy, and asset protection." }
            ].map((step, i) => (
              <motion.div 
                key={i}
                initial={{ opacity: 0, y: 20 }}
