...
import { Check, Laptop, Shield, Headphones } from "lucide-react";
          ...
          <div className="max-w-3xl">
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl font-heading font-bold mb-6 leading-tight">
                ...
                <span className="text-accent">We Handle Tech.</span>
              </h1>
              <p className="text-lg md:text-xl text-blue-100 mb-8 max-w-lg leading-relaxed">
                Proactive IT support, security, and infrastructure management. Keep your systems running smoothly so you can focus on growth.
              </p>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: Laptop, title: "Infrastructure Setup", desc: "Cloud setup, email systems, collaboration tools, and device management." },
              { icon: Shield, title: "Security & Compliance", desc: "Cybersecurity, data backup, disaster recovery, and compliance audits." },
              { icon: Headphones, title: "Ongoing Support", desc: "Help desk, troubleshooting, maintenance, and system monitoring." }
            ].map((step, i) => (
              <motion.div 
                key={i}
                initial={{ opacity: 0, y: 20 }}
            ...
            {[
              {
                name: "Startup IT",
                price: "$799/mo",
                features: ["Cloud Setup (Google/Microsoft)", "Email & Calendar", "Basic Security", "Remote Support", "Up to 10 Users"],
                cta: "Get Started"
              },
              {
                name: "Business IT",
                price: "$1,999/mo",
                popular: true,
                features: ["Everything in Startup", "Advanced Security Suite", "Device Management", "Automated Backups", "Priority Support", "Up to 50 Users", "Monthly Health Checks"],
                cta: "Most Popular"
              },
              {
                name: "Enterprise IT",
                price: "Custom",
                features: ["Everything in Business", "Dedicated IT Manager", "24/7 Monitoring", "Compliance Management", "Custom Integrations", "Unlimited Users", "SLA Guarantee"],
                cta: "Contact Us"
              }
            ].map((pkg, i) => (
              <motion.div
